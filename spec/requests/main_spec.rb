...
describe  "/merb_javascript_named_routes/" do
  ...
  describe "GET /" do
    ...
    before(:each) do
      @response = request("/merb_javascript_named_routes/")
    end
    ...
    it "should render the default slice layout" do
      @response.should have_tag(:h1, :content => "MerbJavascriptNamedRoutes Slice")
